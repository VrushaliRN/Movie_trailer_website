...
"""This section is to provide the information for each movie in the Movie Class which is in the Media Module."""
...
avengers = media.Movie("The Avengers",
                     "story of superheroes come together to protect the earth from evil powers",
...
"""import fresh_tomatoes" allows this code to turn into a movie website by using the function "open_movies_page"  
